...
function Dashboard() {
    ...
    useEffect(() => {
        fetch(`https://localhost:44342/api/Appointment/GetAppointmentsByDoctor?psRFC=${userState.RFC}`, {
            method: "GET"
          })
                    ...
                    <div className="w-11/12 flex flex-col h-full ">
                        ...
                        <div className="panels grid grid-cols-1 gap-9 flex-1">
                            <div className="appointments col-span-1">
                                <TableConsulta headerTitle={headerTitle} headerTable={headerTable} tableInfo={citas} />
                            </div>
                                ...
                                <div className="bg-white shadow-md h-64 border border-blue-hosta rounded-3xl">
                                    <div className="flex flex-col items-center justify-center">
                                        <div className="flex flex-col items-center justify-center py-4">
                                            ...
                                            <h3 className="text-deep-sea-green font-semibold text-xl">Dr. {userState.nombre + ' ' + userState.paterno + ' ' + userState.materno}</h3>
                            ...
                            <div className="medicinal-supplies col-span-1 ">
                                <div className="border-2 w-auto shadow-md rounded-3xl max-h-full h-full border-blue-hosta bg-white">
